...
<?php page_header("Résultats 2022"); ?>
...
<h1>Résultats 2022</h1>

<ul class="resultats-summary">
<li>Le concours s'est déroulé du 6 novembre au 16 décembre 2022.</li>
<li><span class="resultats-important">698&nbsp;449 élèves</span> ont participé.</li>
<li><span class="resultats-important">3&nbsp;874 établissements</span> ont pris part au concours.</li>
</ul>

<p>
Les graphes et tableaux ci-dessous vous permettent de déterminer le classement à partir du score. Par exemple, si vous avez participé individuellement dans la catégorie 6<sup>e</sup> et que vous avez obtenu 200 points, vous pouvez voir dans le tableau que vous êtes classé(e) 13102<sup>e</sup> parmi tous les élèves de votre catégorie.
Notez qu'il y a souvent des ex-aequo. Par exemple 4669 élèves sont ex-aequo à la 13102<sup>e</sup> place dans la catégorie 6<sup>e</sup> avec un score de 200 points.
</p>

<div class="resultats-graphiques" style="margin-top:0.5em;margin-bottom:1em">
<?php include("resultats/resultats2022_castor.php"); ?>
</div>
